...
/*
This class mainly works with prefix, infix and postfix arithmetic expressions, including change between forms and evaluation.
...
Actually, this gives the algorithm generalizing Dijkstra's Two-Stack Algorithm on page 129 in the textbook.

API:
static String InfixToPostfix(String str)				line 23
static double EvaluatePostfix(String str)				line 63
static String PostfixToInfix(String str)				line 79
static String InfixToPrefix(String str)					line 108
static double EvaluatePrefix(String str)				line 155
static String PrefixToInfix(String str)					line 171
static String LeftParenthesesComplete(String str)		line 204
static double EvaluateSimpleInfix(String str)			line 283
*/
public class Expression
{
	...
	{
		String[] s=str.split(" ");
		return PostfixToInfix(s)[0];
	}
	
	//auxiliary function to help with "static String PostfixToInfix(String str)"
	...
	{
		String[] s=str.split(" ");
		return PrefixToInfix(s)[0];
	}
	
	//auxiliary function to help with "static String PrefixToInfix(String str)"
	...
	public static void main(String[] args)
	{
		...
		StdOut.println("Convering back to infix expression\t\""+Expression.PostfixToInfix(postfix)+"\"");
		...
		StdOut.println("Convering back to infix expression\t\""+Expression.PrefixToInfix(prefix)+"\"");
		...
		String simpleinfix=LeftParenthesesComplete(infix);
